...
Doc.prototype = {
    ...
    */
    convertUrlToAbsolute: function(url) {
        ...
        if (url.substr(-1) == '/') {
            converted = 'documentation/' + this.group + '/' + url + 'index'
        } else if (url.match(/\//)) {
            //if it is not at the root
            return 'documentation/' + this.group + '/' + url;
        } else {
            converted = 'documentation/' + this.group + '/' + this.section + '/' + url;
        }
