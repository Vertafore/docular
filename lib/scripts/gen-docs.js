    ...
    sections: [
        {
            ...
            rank: {'installnode':1, 'installgrunt':2, 'configure':3, 'learn':4}
        },
        {
            id: "docularoverview",
            title: "Creating Documentation",
            docs: [
                "lib/scripts/docs/overview"
            ],
            rank: {'workflow':1, 'preddo':2, 'ddo':3, 'children':4, 'partial':5, 'divisions':6}
        },
        {
            id: "docularext",
...
var generate = function (options_in, callBack) {
    ...
    var processGroup = function (sectionObj, groupId, doc_apis) {
        ...
        console.log('Extracting ' + groupId.cyan + ' DDOs For Section "' + sectionObj.id.cyan + '"...');
    ...
    var copyToDir = function(){        
        ...
        writer.copyDir(REL_WEBAPP, destDir);
    }

    /*============ INITIALIZATION ============*/

    //Once the partials directories are created we should get the doc_apis
    ...
    //Next we need to process all the groups
        ...
        console.section("generating DDO's");
    ...
    //then we have all the docs into the docs array so time to do some post processing
        ...
        console.section("merging child DDO's with parent DDO's");
        try{
