...
var defaultOptions = {
    ...
    css: [
        'resources/libraries/highlight-js/styles/github.css'
    ...
    dependencies: [
        ...
        {package: 'highlight-js', version: '8.4', files: [['src/highlight.js', 'highlight.js'],['src/styles/github.css', 'github.css'], ['src/languages', 'languages']], savedir: 'highlight-js'}
    ],
