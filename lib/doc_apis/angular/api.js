...
var Example = require('../../scripts/example.js').Example;
...
module.exports =  {
    ...
    ui_resources : {
        js : ['resources/api_ui_behavior.js'],
        css : ['resources/api_ui_styles.css']
    },
    ...
    markdown : {
        ...
        'angular' : {
            ...
            markdown : function (text, placeholder) {
                ...
                var parts = doc_utils.trim(text).split(/(<doc:example(\S*).*?>[\s\S]*?<\/doc:example>|<example[^>]*>[\s\S]*?<\/example>)/);
