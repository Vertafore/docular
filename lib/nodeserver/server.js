...
function main(argv) {
    ...
    //First move to the webapp
    var isInWebAPP = /\/docular\/lib\/webapp$/;
    if( !isInWebAPP.test( doc_utils.normalizeFile(process.cwd())) ){
        var toWebapp = path.relative(process.cwd(), __dirname + '/../webapp');
        process.chdir(toWebapp);
    }
...
StaticServlet.prototype.handleRequest = function(req, res) {
  ...
  // docs rewriting
  var REWRITE = /\/(.*)$/,
      IGNORED = /(\.(css|js|png|jpg|woff|ttf|otf|eot)$|partials\/.*\.html$)/,
      match;
