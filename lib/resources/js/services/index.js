                ...
                search: function (params) {
                    ...
                    if(!documentation) {
                        this.load().then(function () {
                            self.search(params).then(deferred.resolve).catch(deferred.reject);
                    ...
                    for(var i = 0, l = documentation.length; i < l; i++) {
                        var found = true, doc = documentation[i];
                        for(var ki = 0, kl = keys.length; ki < kl; ki++) {
                            key = keys[ki];
                            console.log(key, doc[key], params[key])
